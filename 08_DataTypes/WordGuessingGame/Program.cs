...
class WordGuessingGame
{
    ...
    public WordGuessingGame()
    {
        ...
        wordCategories.Add("Countries", new List<string> { "India", "France", "Canada", "Jamaica", "Japan" });
        wordCategories.Add("Fruits", new List<string> { "apple", "peach", "mango", "orange", "blueberry" });
    }
